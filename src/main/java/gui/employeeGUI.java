...
public class employeeGUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String emp_name = this.jTextField1.getText();
        String emp_address = this.jTextField2.getText();
        String emp_phone = this.jTextField3.getText();
        
        System.out.println("User input = "+emp_name+","+emp_address+","+emp_phone);
        myConnector connect = new myConnector();
        connect.insertEmployee(emp_name, emp_address, emp_phone);
